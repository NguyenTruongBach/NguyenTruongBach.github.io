...
First, create a new CSS file in your local `static
/NguyenTruongBach.github.io/css` folder prefixed by `theme` (e.g. with _mine_ theme `static
/NguyenTruongBach.github.io/css/theme-mine.css`). Copy the following content and modify colors in CSS variables.
